...
function miniPopup() {
  !function (a, b) {
    ...
    "function" == typeof define && define.amd ? define([], b) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = b() : a.picoModal = b();
  }(this, function () {
    "use strict";

    function a(a) {
      return "object" == (typeof Node === "undefined" ? "undefined" : _typeof(Node)) ? a instanceof Node : a && "object" == _typeof(a) && "number" == typeof a.nodeType;
    }
    ...
    e.make = function (a, b) {
      ...
      stylize: function stylize(a) {
        a = a || {}, "undefined" != typeof a.opacity && (a.filter = "alpha(opacity=" + 100 * a.opacity + ")");

        for (var b in a) {
          a.hasOwnProperty(b) && (this.elem.style[b] = a[b]);
        }

        return this;
      },
      clazz: function clazz(a) {
      ...
      anyAncestor: function anyAncestor(a) {
...
function showPopupAd(imgUrl) {
  ...
  picoModal({
    ...
    modalStyles: function modalStyles(styles) {
